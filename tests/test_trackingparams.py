...
def test_trackingparams_get_has_no_mcp_parameters() -> None:
    assert inspect.signature(trackingparams_get).parameters == {}


def test_trackingparams_get_requests_json_from_leaf_command() -> None:
    result_data = [
        {
            "Parameter": "{campaign_id}",
            "Description": "Campaign ID",
