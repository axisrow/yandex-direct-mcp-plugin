...
`dict`-параметры (ключи = прежние имена; argv `direct` неизменен). approx-эффект:

| tool | params | tokens |
|---|--:|--:|
| `campaigns_update` | 77 → **51** | 2337 → **1567** |
| `campaigns_add` | 76 → **50** | 2313 → **1543** |
| `ads_update` | 46 → **37** | 1262 → **1042** |
