---
name: direct-eda
description: "Разведочный анализ (EDA) статистики Яндекс.Директ поверх отчётов. Активируй когда пользователь просит проанализировать статистику/данные, найти тренды или аномалии, построить разрез по времени/устройствам/гео/полу-возрасту, выбрать топ/антитоп кампаний, ключей или объявлений, оценить эффективность (CTR, CR, CPA, ROAS) и дать выводы/рекомендации."
user-invocable: true
