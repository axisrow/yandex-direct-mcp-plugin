---
name: yandex-direct
description: "Управление Яндекс.Директ через direct-cli с аутентификацией Bitwarden. Используй этот скилл когда пользователь упоминает Яндекс.Директ, хочет просмотреть кампании, объявления, ключевые слова, статистику кампаний, управлять бюджетом, ставками или ключевыми словами, включить/отключить кампанию или объявление, получить отчёты по объявлениям, проверить статус кампании, считать количество объявлений по кампаниям, или выполнить другие операции с аккаунтом Директа. Также активируй если пользователь спрашивает про работу с direct-cli."
user-invocable: true
